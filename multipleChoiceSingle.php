...
if ($_POST['submit'] == "Save Question")
 ...
 if ($category == '')
  ...
  $query = "insert into question (questionid,question,choice1,choice2,choice3,choice4,choice5,choice6,answer,date,feedback,category,reference, examid,type ) VALUES (NULL, '$question', '$choice1', '$choice2', '$choice3', '$choice4', '$choice5', '$choice6', '$answer', '$date','$feedback', '$category', '$reference', '$examid', 'mcs')";
...
//else if ((document.form.correctAns.checked))
// { validity = false; alert('No Answer Selected, Please select a Answer'); }
//  for (var i = 0; i < document.form.correctAns.length ; i++)
//    if (document.form.correctAns[i].checked)
//{ validity = false; alert('No Answer Selected, Please select a Answer'); }
...
<form name="form" enctype="multipart/form-data" action="multipleChoiceSingle.php" method="post" onsubmit="return validate()">
...
<tr>
       ...
       <td>A)<input name='correctAns' id='correctAns' type='radio' value='a' ></td>
       <td align='left'><textarea name='choice1' rows='2' cols='55'></textarea></td>
</tr>
<tr>
       <td align='right' bgcolor='#dfdfdf'>&nbsp;</td>
       <td>B)<input name='correctAns' id='correctAns' type='radio' value='b'></td>
       <td><textarea name='choice2' rows='2' cols='55'></textarea></td>

</tr>
<tr>
       <td align='right' bgcolor='#dfdfdf'>&nbsp;</td>
       <td>C)<input name='correctAns' id='correctAns' type='radio' value='c'></td>
       <td><textarea name='choice3' rows='2' cols='55'></textarea></td>
</tr>
<tr>
       <td align='right' bgcolor='#dfdfdf'>&nbsp;</td>
       <td>D)<input name='correctAns' id='correctAns' type='radio' value='d'></td>
       <td><textarea name='choice4' rows='2' cols='55'></textarea></td>

</tr>
<tr>
       <td align='right' bgcolor='#dfdfdf'>&nbsp;</td>
       <td>E)<input name='correctAns' id='correctAns' type='radio' value='e'></td>
       <td><textarea name='choice5' rows='2' cols='55'></textarea></td>
</tr>
<tr>
       <td align='right' bgcolor='#dfdfdf'>&nbsp;</td>
       <td>F)<input name='correctAns' id='correctAns' type='radio' value='f'></td>
