...
if ($_POST['submit'] == "Save Question")
 ...
 if ($category == '')
  ...
  $query = "insert into question (questionid,question,answer,date,feedback,category,reference, examid, type ) VALUES (NULL, '$question','$answer', '$date','$feedback', '$category', '$reference', '$examid', 'tf')";
...
<form name="form" enctype="multipart/form-data" action="trueFalse.php" method='post' onsubmit="return validate()">
<tr>
...
<tr>
       ...
       <td>True<input name=correctAns type='radio' value='true'></td>     
</tr>
<tr>
       <td align='right' bgcolor='#dfdfdf'>&nbsp;</td>
       <td>False<input name=correctAns type='radio' value='false'></td>       
</tr>
<tr>
