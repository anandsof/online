...
if ($_POST['submit'] == "Save Question")
 ...
 if ($category == '')
  ...
  $query = "insert into question (questionid,question,choice1,choice2,choice3,choice4,choice5,choice6,answer,date,feedback,category,reference, examid,type ) VALUES (NULL, '$question', '$choice1', '$choice2', '$choice3', '$choice4', '$choice5', '$choice6', '$answer', '$date','$feedback', '$category', '$reference', '$examid', 'dd')";
...
{ 
  ...
  else if (((!check_empty(document.form.choice1a.value))||(!check_empty(document.form.choice1b.value))) && ((!check_empty(document.form.choice2a.value))||(!check_empty(document.form.choice2b.value))) && ((!check_empty(document.form.choice3a.value))||(!check_empty(document.form.choice3b.value))) && ((!check_empty(document.form.choice4a.value))||(!check_empty(document.form.choice4b.value))) && ((!check_empty(document.form.choice5a.value))||(!check_empty(document.form.choice5b.value))) && ((!check_empty(document.form.choice6a.value))||(!check_empty(document.form.choice6b.value))))
...
<h3>Matching Question</h3>
<font color=GREEN><?php print("$message") ?></font><BR>
<table border='0' width="100%">
<form name="form" enctype="multipart/form-data" action="dragDrop.php" method="post" onsubmit="return validate()">
...
<tr>
       <td align='right' bgcolor='#dfdfdf'>&nbsp;A)</td>
       <td><textarea name='choice1a' rows='2' cols='20'></textarea></td>
       <td><textarea name='choice1b' rows='2' cols='20'></textarea></td>
</tr>
<tr>
       <td align='right' bgcolor='#dfdfdf'>&nbsp;B)</td>
       <td><textarea name='choice2a' rows='2' cols='20'></textarea></td>
       <td><textarea name='choice2b' rows='2' cols='20'></textarea></td>

</tr>
<tr>
       <td align='right' bgcolor='#dfdfdf'>&nbsp;C)</td>
       <td><textarea name='choice3a' rows='2' cols='20'></textarea></td>
       <td><textarea name='choice3b' rows='2' cols='20'></textarea></td>
</tr>
<tr>
       <td align='right' bgcolor='#dfdfdf'>&nbsp;D)</td>
       <td><textarea name='choice4a' rows='2' cols='20'></textarea></td>
       <td><textarea name='choice4b' rows='2' cols='20'></textarea></td>

</tr>
<tr>
       <td align='right' bgcolor='#dfdfdf'>&nbsp;E)</td>
       <td><textarea name='choice5a' rows='2' cols='20'></textarea></td>
       <td><textarea name='choice5b' rows='2' cols='20'></textarea></td>
</tr>
<tr>
       <td align='right' bgcolor='#dfdfdf'>&nbsp;F)</td>
       <td><textarea name='choice6a' rows='2' cols='20'></textarea></td>
       <td><textarea name='choice6b' rows='2' cols='20'></textarea></td>
